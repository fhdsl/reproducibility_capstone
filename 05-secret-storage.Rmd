...
<p class=buttontext><input type="checkbox">  Scroll to bottom and click the green <div class="github_button">Generate token</div> button.<br/><br/></p>
...
<p class=buttontext><input type="checkbox"> Click the green <div class="github_button"> Add secret</div> button <br/><br/></p>
...
<p class=buttontext><input type="checkbox"> Click green <div class="github_button"> Run workflow</div> button again to confirm<br/><br/></p>
