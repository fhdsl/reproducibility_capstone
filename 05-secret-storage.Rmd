...
2. Click "Settings" from the dropdown menu (you will see a gear icon `include <img src='resources/icons/settings.png' alt='settings icon' class = icon width = '200px'>" )
