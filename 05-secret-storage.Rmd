...
<input type="checkbox"> GitHub may ask for your password - enter it to continue<br/>
...
::: {.warning}
**Warning:** If you navigate away without copying the token, you'll need to create a new one!
:::
...
<input type="checkbox"> Watch for the workflow to start running (you'll see a yellow circle, then green checkmark or red X)
<input type="checkbox"> Navigate to the "Issues" tab in your repository
<input type="checkbox"> Look for a new issue created by the evaluation system
<input type="checkbox"> Click on the issue to see detailed results
<input type="checkbox"> Interpret the results and proceed accordingly:<br/>
  ...
  &nbsp;&nbsp;&nbsp;&nbsp; <input type="checkbox"> If the issue title indicates failure, and the description of the issue contains error messages, visit Phase 4: Troubleshooting and Refinement of these insturctions.<br/>

## Phase 4: Troubleshooting and Refinement

### Step 11: Debug Failures
...
```
ADD a figure for iteration here
```
...
<input type="checkbox"> Find the Assignment 3 question<br/>
<input type="checkbox"> When prompted, paste the validation code exactly as provided in the issue<br/>
<input type="checkbox"> Submit the quiz to get credit for your work<br/>

### Step 15: Clean Up (Optional but Recommended)
