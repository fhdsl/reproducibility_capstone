...
<input type="checkbox"> In the left sidebar, find "Secrets and variables" `r config::get("secrets")`<br/>
...
<input type="checkbox"> Return to the Actions tab `r config::get("action")`<br/>
