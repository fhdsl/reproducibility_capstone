...
<input type="checkbox"> <p class = buttontext> Scroll to bottom and click the green <div class="github_button">Generate token</div> button.</p><br/>
...
<input type="checkbox"> <p  class =buttontext> Click the green <div class="github_button"> Add secret</div> button </p><br/>
...
<input type="checkbox"> <p class = buttontext> Click green <div class="github_button"> Run workflow</div> button again to confirm <p> <br/>
