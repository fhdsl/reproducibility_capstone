...
```{r, out.width = "100%", fig.alt = "Learning Objectives: Recognize the uses of GitHub Actions and plan for project needs, Build and implement a GitHub Action, Test and monitor a Github Action", echo = FALSE}
...
GitHub Actions [can be triggered](https://hutchdatascience.org/GitHub_Automation_for_Scientists/no_toc/github-actions-fundamentals.html#on-when-a-thing-should-be-run) by specific actions (such as opening a pull request, merging a branch, or opening an issue) or on a schedule, and can [perform many tasks](https://hutchdatascience.org/GitHub_Automation_for_Scientists/no_toc/github-actions-fundamentals.html#jobs-what-should-be-run), perhaps even [using a specific container or environment](https://hutchdatascience.org/GitHub_Automation_for_Scientists/no_toc/github-actions-fundamentals.html#runs-on-with-what).
...
- Check the logs: Go to the Actions tab `r config::get("actions")` and examine detailed output
