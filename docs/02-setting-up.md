...
## Phase 0: Revisiting Working with GitHub

This setting up activity will utilize several fundamental principles summarized in the [Intro to](https://jhudatascience.org/Reproducibility_in_Cancer_Informatics/no_toc/index.html) and [Advanced Reproducibility in Cancer Informatics](https://jhudatascience.org/Adv_Reproducibility_in_Cancer_Informatics/no_toc/index.html) courses. Revisit these courses as needed for more information on these concepts, including

* [cloning a repository that exists online to your local computer](https://jhudatascience.org/Adv_Reproducibility_in_Cancer_Informatics/no_toc/using-version-control-with-github.html#git-clone)
* [creating branches in order to develop code, analysis, etc. in a working copy of your repository](https://jhudatascience.org/Adv_Reproducibility_in_Cancer_Informatics/no_toc/using-version-control-with-github.html#create-a-branch)
* [where GitHub Action workflow files (yaml files) are expected to be within a repository](https://jhudatascience.org/Adv_Reproducibility_in_Cancer_Informatics/no_toc/automation-as-a-reproducibility-tool.html#structure-of-github-actions-file) for GitHub to recognize them as a workflow file
