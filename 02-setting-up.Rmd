...
<input type="checkbox"> <p class = buttontext> Look for the <div class = "github_button"> <a  href="https://github.com/new?template_name=capstone-sandbox&template_owner=fhdsl" class = "github_button_link"> Use this template</a></div> green button at the top of the repository page<br/></p>
...
<input type="checkbox"> <p class = buttontext>Click <div class = "github_button"> <a href="https://github.com/new?template_name=capstone-sandbox&template_owner=fhdsl" class = "github_button_link"> Use this template</a></div> and select the "Create a new repository" option (if needed).<br/></p>
