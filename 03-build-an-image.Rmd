...
<input type="checkbox"> <p class = buttontext> Finally, after you see "Pull Request successfully merged and closed displayed, you can click the gray <div class="github_gray_button"> Delete branch</div> button. </p> <br/>
