...
Because you've received a validation code (congrats!), you can treat that like a team member approved your pull request. Go ahead and merge the PR and delete your branch so that your Dockerfile will be on the main branch, available for use in a later assignment if you want it.
...
<input type="checkbox"> Finally, after you see "Pull Request successfully merged and closed displayed, you can click the gray "Delete branch" button. <br/>
